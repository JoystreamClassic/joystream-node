...
class Torrent extends EventEmitter {
  ...
  addTorrentPlugin (torrentPluginStatus) {
    if (this.torrentPlugin) {
      ...
      this.torrentPlugin = new TorrentPlugin(torrentPluginStatus, this.plugin, this.peers)
  ...
  startBuying (connection, contractSk, finalPkHash, callback) {
    // var infoHash = this.handle.infoHash()
    if (connection.innerState === InnerStateTypeInfo.PREPARING_CONTRACT) {
      console.log('READY !')
    }
  }
