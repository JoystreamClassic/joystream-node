...
TorrentPlugin._Error = function _Error(name, message) {
    this.name = name;
...
TorrentPlugin.InvalidArgumentError = function InvalidArgumentError(message) {
    TorrentPlugin._Error.call(this, 'InvalidArgumentError', message)
}

TorrentPlugin.NotEnoughSellersError = function NotEnoughSellersError(message) {
    TorrentPlugin._Error.call(this, 'NotEnoughSellersError', message)
}

TorrentPlugin.NoSellersError = function NoSellersError(message) {
    TorrentPlugin._Error.call(this, 'NoSellersError', message)
}

TorrentPlugin.InvalidStateError = function InvalidStateError(message) {
    TorrentPlugin._Error.call(this, 'InvalidStateError', message)
}
